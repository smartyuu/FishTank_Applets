...
const _sfc_main = {
  ...
  computed: {
    progressStyle() {
      ...
      style.height = common_vendor.index.$u.addUnit(this.height);
      return style;
    },
    innserPercentage() {
      return common_vendor.index.$u.range(0, 100, this.percentage);
    }
  },
  mounted() {
    this.init();
  ...
  methods: {
    init() {
      common_vendor.index.$u.sleep(20).then(() => {
        this.resizeProgressWidth();
      });
    },
    getProgressWidth() {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-eeee7090"], ["__file", "C:/Users/Yiweiyihang/OneDrive/桌面/FishTank_Applets/test/test/uni_modules/uview-plus/components/u-line-progress/u-line-progress.vue"]]);
